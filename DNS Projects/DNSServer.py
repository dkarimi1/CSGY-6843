...
def run_dns_server():
    ...
    while True:
        try:
            ...
            request = dns.message.from_wire(data,addr)
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    minimum, mname, rname, refresh, serial, expire, retry = answer_data # What is the record format? See dns_records dictionary. Assume we handle @, Class, TTL elsewhere. Do some research on SOA Records
                    rdata = SOA(dns.rdataclass.IN, dns.rdatatype.SOA, minimum, mname, rname, refresh, serial, expire, retry) # follow format from previous line
